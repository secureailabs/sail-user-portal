...
export const getAllVirtualMachinesAPIdemo = async (
  data: TGetAllVirtualMachinesStart
): Promise<TGetAllVirtualMachinesSuccess> => {
  return demo_data;
};
...
const VirtualMachinesContainer: React.FC = () => {
  ...
  const { data, status, error } = useQuery<
    TGetAllVirtualMachinesSuccess['secure_computation_nodes'],
    AxiosError
    // @ts-ignore
  >(['datasets'], apiFunction, { refetchOnMount: 'always' });
