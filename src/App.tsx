...
import { DefaultService, OpenAPI, RefreshToken_In, UserInfo_Out } from 'src/client';
...
const App: React.FC<AppProps> = ({
  ...
  // @ts-ignore
  useQuery<UserInfo_Out, AxiosError>(['userData'], checkUserSession, { retry: false, refetchInterval: 600000, staleTime: 600000 });
